    ...
    return Scaffold(
      body: BlocProvider(
        create: (context) => LoginBloc(
          // Obtenemos el repositorio desde el Service Locator
          authRepository: sl<AuthRepository>(),
          // Obtenemos el AuthBloc global
...
class _LoginFormState extends State<LoginForm> {
  ...
  @override
  Widget build(BuildContext context) {
    // Listener para manejar la redirección basada en el rol cuando el usuario se autentica
        ...
        if (authState.status == AuthStatus.authenticated) {
          ...
          if (user != null) {
            if (user.role == 'WORKSHOP_ADMIN') {
              context.go('/admin'); // Dashboard de taller
            } else {
              context.go('/'); // Dashboard de cliente (Garaje)
            }
          }
        }
      },
      // Listener para manejar errores específicos del Login (credenciales incorrectas, etc.)
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // --- AQUÍ ESTÁ EL BOTÓN DE OLVIDASTE CONTRASEÑA ---
                      Align(
